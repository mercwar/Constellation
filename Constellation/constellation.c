...
/* ------------------------------------------------------------
   AVIS.HEADER
   ROLE: CONSTELLATION_MAIN_PROGRAM
   PURPOSE: Scans repos for Constellation folders and loads all
            versioned intelligence (past, present, future).
   AUTHOR: Demon
   NOTES: This is the FIRST VERSION of the FIRST CONSTELLATION
          PROGRAM. All repos will eventually contain a version
          of this file.
   ------------------------------------------------------------ */
...
/* ------------------------------------------------------------
   ...
   PURPOSE: Detects if a folder name looks like a version
            Examples:
            v1, v2, v3
            version1, version2
            1.0, 2.0.1
...
/* ------------------------------------------------------------
   ...
   PURPOSE: Scans a /Constellation folder inside ANY repo and
            collects all version folders + root version files.
   ------------------------------------------------------------ */
...
/* ------------------------------------------------------------
   ...
   PURPOSE: Displays all discovered versions
   ------------------------------------------------------------ */
...
/* ------------------------------------------------------------
   MAIN PROGRAM
   PURPOSE: Entry point for the Constellation intelligence loader
   ------------------------------------------------------------ */
